...
$Referer_check_domain = "hanetuki.com";
...
メールフォームのご利用ありがとうございます。
3営業日以内にご返信致しますので今しばらくお待ちください。
返信がない場合はエラーなどの可能性がありますので、
お手数ですが再度touka.hanetuki@gmail.comへご連絡ください。
...
──────────────────────
はねつきとうか
E-mail: touka.hanetuki@gmail.com
URL: http://www.hanetuki.com
...
<html lang="ja">
	...
	<body>
		<section id="result">
			...
			<?php }else{ ?>
				<div class="content_wrap">
					<!-- <img class="top-logo" src="img/parts/top-logo.png">					 -->
					<h3>
						送信ありがとうございました。<br />
						送信は正常に完了しました。
					</h3>
